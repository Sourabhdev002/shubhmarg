      ...
      >
        ...
        >
          ...
          <div className="relative min-w-0 flex-1">
            <p className="text-[10px] sm:text-[11px] font-bold uppercase tracking-[0.16em] text-[#C25E10] mb-1 whitespace-nowrap">
              {"\u0906\u091C \u0915\u093E \u0906\u0936\u0940\u0930\u094D\u0935\u093E\u0926"} {"\u00b7"} Aaj Ka Aashirwad
            </p>
            <p className="text-[14px] sm:text-[16px] font-cormorant font-semibold text-[#2A1810] leading-snug">
              Aaj ka margdarshan + naam ka diya
            </p>
          </div>
